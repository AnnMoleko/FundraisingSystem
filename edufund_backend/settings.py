"""
Django settings for edufund_project project.
"""
...
ROOT_URLCONF = 'edufund_backend.urls'
...
WSGI_APPLICATION = 'edufund_backend.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@edufund.com')
